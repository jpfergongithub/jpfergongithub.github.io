+++
date = '2019-01-19T13:22:29-05:00'
draft = true
title = 'First post'
+++

"Hello World" messages are a cliche, but here goes. I've had a web presence of some sort since 1996, but done my best not to learn much about actual web design. Thus my typical web page has been hosted on a university server where I've had an account. Real "www.university.edu/~user" sort of stuff. Since I haven't focused on web development since before CSS became a standard, this did not push me too hard.
